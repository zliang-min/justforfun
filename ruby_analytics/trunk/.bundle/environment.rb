...
module Bundler
  LOCKED_BY    = '0.9.19'
  FINGERPRINT  = "54edf876b566cac3b34237e6e9a7d014e95c27a8"
  HOME         = '/home/gimi/.bundle/ruby/1.8/bundler'
  AUTOREQUIRES = {:default=>[["rack", false], ["sequel_core", true], ["sqlite3-ruby", false]]}
  SPECS        = [
        {:load_paths=>["/usr/local/share/rubygems/gems/rack-1.1.0/lib"], :name=>"rack", :loaded_from=>"/usr/local/share/rubygems/specifications/rack-1.1.0.gemspec"},
        {:load_paths=>["/usr/local/share/rubygems/gems/sequel-3.9.0/lib"], :name=>"sequel", :loaded_from=>"/usr/local/share/rubygems/specifications/sequel-3.9.0.gemspec"},
        {:load_paths=>["/usr/local/share/rubygems/gems/sqlite3-ruby-1.2.5/lib", "/usr/local/share/rubygems/gems/sqlite3-ruby-1.2.5/ext"], :name=>"sqlite3-ruby", :loaded_from=>"/usr/local/share/rubygems/specifications/sqlite3-ruby-1.2.5.gemspec"},
      ].map do |hash|
