(function () {
  var aa = "_rat",
    ba = "_raq",
    host = "http://test.51hejia.com:3000/",
    r = true,
    v = false,
    w = undefined,
    ca = "4.6.5",
      ...
      if (n[1] < 500 || a) {
        ...
        if (a || !j || n[2] >= 1) {
          ...
          if (1 == s || 2 == s) {
            ...
            f = host + "__utm.gif" + f + "&utmac=" + h + "&utmcc=" + l.ac(d);
            if (ka) f += "&gaq=1";
            l.$a(f, c)
          }
        }
  ...
  Z.aa = function (i, l) {
    ...
    function t() {
      // Gimi: cookie doesn't belong to domain: google.com and path /
      var b = c.b,
    ...
    function p() {
      // Gimi: determin if need to track.
    ...
    a.wa = function (b) {
      ...
      // Gimi: I added utmrr for refer (utmr is outter refer)
      e += "&utmhid=" + ja() + "&utmr=" + S(a.ia) + "&utmp=" + S(a.Bc(b)) + "&utmrr=" +S(a.ab);
      return e
    };
    a.Bc = function (b) {
      var e = c.a[A];
    ...
    a.pc = function () {
      ...
      e.tb(F.join(".")); // ensure elements in F are all integers
      I[0] = m;
      I[1] = I[1] ? I[1] : 0;
      I[2] = w != I[2] ? I[2] : c.Jc;
      I[3] = I[3] ? I[3] : F[4];
